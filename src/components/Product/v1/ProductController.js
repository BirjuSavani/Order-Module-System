...
class ProductController {
    ...
    async get(req, res) {
        ...
        try {
            ...
            return res.status(500).json({ error: "Can't Find Products" });
        }
    }
    ...
    async getcategories(req, res) {
        try {
            ...
            return res.status(500).json({ error: "Can't Find Products Categories" });
        }
    ...
    async getcategory(req, res) {
        try {
            ...
            return res.status(500).json({ error: `Can't Find Products Categories data` });
        }
    }
    ...
    async getcategorybrand(req, res) {
        try {
            ...
            console.log("Can't Find Products Categories brand data \n" + error);
            return res.status(500).json({ error: "Can't Find Products Categories brand data" });
        }
    }
    ...
    async getOneProduct(req, res) {
        ...
        try {
            ...
            await transaction.rollback();
            return res.status(500).json({ error: `${id} Can't Find Product data` });
        }
    }
    ...
    async updateOneProduct(req, res) {
        ...
        try {
            ...
            return res.status(500).json({ error: "Can't updated Product details" });
        }
    }
    ...
    async deleteProduct(req, res) {
        ...
        try {
            ...
            await transaction.rollback();
            return res.status(500).json({ error: "Can't Delete Product" });
        }
    }
